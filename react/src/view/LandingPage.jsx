    ...
    return (
        ...
        <div className="slide-container">
            ...
            >
                <div className="slider-content">
                    ...
                    <button className="shopping-btn">{images[index].content.btn}</button>
                </div>
            </div>
        </div>
        <div className="index-section container">
            <div className="index-content row">
                <p className="index-paragraph col-md-6 offset-md-3">
                    ...
                    Discover our story 
                    and meet the people that make our brand what it is.
                    </em>
                </p>
            </div>
        </div>
        <FeaturedProduct image = {images}/>
        <FeaturedCollection image = {images}/>
        <div className="news-letter-section">
            <div className="letter-content">
                ...
                Sign up to stay in the loop. Receive
                 updates, access to exclusive deals, and more.
                </p>
                <div className="divider"></div>
            </div>
            <form action="" className="letter-form">
                <input type="email" name="mail" className="letter-mail" placeholder="Your email"/>
